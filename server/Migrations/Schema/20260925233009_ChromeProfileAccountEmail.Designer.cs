...
namespace EndpointPlatform.Migrations.Schema
{
    ...
    [Migration("20260925233009_ChromeProfileAccountEmail")]
    partial class ChromeProfileAccountEmail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EndpointPlatform.Domain.BitLocker.BitLockerRecoveryEscrow", b =>
                {
                    ...
                    b.Property<string>("DeletedByDisplay")
                        .HasMaxLength(320)
                        .HasColumnType("character varying(320)")
                        .HasColumnName("deleted_by_display");
                    ...
                    b.Property<string>("EscrowedByDisplay")
                        .IsRequired()
                        .HasMaxLength(320)
                        .HasColumnType("character varying(320)")
                    ...
                    b.Property<DateTimeOffset?>("LastRevealedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_revealed_at");

                    b.Property<Guid?>("LastRevealedByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("last_revealed_by_user_id");
                    ...
                    b.Property<string>("SealedRecoveryPassword")
                        ...
                        .HasColumnName("sealed_recovery_password");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_bitlocker_recovery_escrows");
                    ...
                    b.ToTable("bitlocker_recovery_escrows", "endpoint_platform");
                });

            modelBuilder.Entity("EndpointPlatform.Domain.Chrome.ChromeExtension", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("ChromeProfileId")
                        .HasColumnType("uuid")
                        .HasColumnName("chrome_profile_id");
                    ...
                    b.Property<DateTimeOffset?>("ExtensionUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("extension_updated_at");

                    b.Property<bool?>("FromWebStore")
                        .HasColumnType("boolean")
                        .HasColumnName("from_web_store");
                    ...
                    b.HasIndex("ChromeProfileId", "ExtensionId")
                        .IsUnique()
                        .HasDatabaseName("ux_chrome_extensions_profile_extension");

                    b.ToTable("chrome_extensions", "endpoint_platform");
                });

            modelBuilder.Entity("EndpointPlatform.Domain.Chrome.ChromeInstallation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("InstallationScope")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                        .HasColumnName("installation_scope");

                    b.Property<string>("InstalledForUser")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("installed_for_user");

                    b.Property<DateTimeOffset?>("LastUpdateCheck")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_update_check");
                    ...
                    b.Property<string>("UpdaterVersion")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("updater_version");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_chrome_installations");

                    b.HasIndex("DeviceId")
                        .IsUnique()
                        .HasDatabaseName("ux_chrome_installations_device_id");

                    b.ToTable("chrome_installations", "endpoint_platform");
                });

            modelBuilder.Entity("EndpointPlatform.Domain.Chrome.ChromeProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("ChromeInstallationId")
                        .HasColumnType("uuid")
                        .HasColumnName("chrome_installation_id");
            ...
            modelBuilder.Entity("EndpointPlatform.Domain.Devices.DeviceBitLockerVolume", b =>
                {
                    ...
                    b.Property<bool?>("HasTpmPinProtector")
                        .HasColumnType("boolean")
                        .HasColumnName("has_tpm_pin_protector");

                    b.Property<bool?>("HasTpmProtector")
                        .HasColumnType("boolean")
                        .HasColumnName("has_tpm_protector");
                    ...
                    b.Property<string>("TpmPinProtectorIds")
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)")
                        .HasColumnName("tpm_pin_protector_ids");

                    b.Property<string>("TpmProtectorIds")
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)")
                        .HasColumnName("tpm_protector_ids");
            ...
            modelBuilder.Entity("EndpointPlatform.Domain.Devices.DeviceSoftware", b =>
                {
                    ...
                    b.Property<string>("PackageFamilyName")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("package_family_name");

                    b.Property<string>("PackageFullName")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("package_full_name");
            ...
            modelBuilder.Entity("EndpointPlatform.Domain.Devices.DeviceSoftwareEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("DeviceSoftwareId")
                        .HasColumnType("uuid")
                        .HasColumnName("device_software_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_device_software_evidence");

                    b.HasIndex("DeviceSoftwareId")
                        .HasDatabaseName("ix_device_software_evidence_device_software_id");

                    b.ToTable("device_software_evidence", "endpoint_platform");
                });
            ...
            modelBuilder.Entity("EndpointPlatform.Domain.Software.SoftwareDeployment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_software_deployments");

                    b.HasIndex("OrganizationId", "CreatedAt")
                        .HasDatabaseName("ix_software_deployments_org_created");

                    b.ToTable("software_deployments", "endpoint_platform");
                });

            modelBuilder.Entity("EndpointPlatform.Domain.Software.SoftwareDeploymentTarget", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ObservedVersion")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("observed_version");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_software_deployment_targets");

                    b.HasIndex("DeviceId")
                        .HasDatabaseName("ix_software_deployment_targets_device_id");

                    b.HasIndex("TaskId")
                        .HasDatabaseName("ix_software_deployment_targets_task_id");

                    b.HasIndex("DeploymentId", "DeviceId", "Attempt")
                        .IsUnique()
                        .HasDatabaseName("ux_software_deployment_targets_deployment_device_attempt");

                    b.ToTable("software_deployment_targets", "endpoint_platform");
                });
            ...
            modelBuilder.Entity("EndpointPlatform.Domain.BitLocker.BitLockerRecoveryEscrow", b =>
                {
                    b.HasOne("EndpointPlatform.Domain.Devices.Device", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_bitlocker_recovery_escrows_devices_device_id");
                });

            modelBuilder.Entity("EndpointPlatform.Domain.Chrome.ChromeExtension", b =>
                {
                    b.HasOne("EndpointPlatform.Domain.Chrome.ChromeProfile", null)
                        .WithMany()
                        .HasForeignKey("ChromeProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chrome_extensions_chrome_profiles_chrome_profile_id");
                    ...
                    b.HasOne("EndpointPlatform.Domain.Devices.Device", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chrome_extensions_devices_device_id");
                });
            ...
            modelBuilder.Entity("EndpointPlatform.Domain.Chrome.ChromeInstallation", b =>
                {
                    b.HasOne("EndpointPlatform.Domain.Devices.Device", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chrome_installations_devices_device_id");
                });

            modelBuilder.Entity("EndpointPlatform.Domain.Chrome.ChromeProfile", b =>
                {
                    b.HasOne("EndpointPlatform.Domain.Chrome.ChromeInstallation", null)
                        .WithMany()
                        .HasForeignKey("ChromeInstallationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chrome_profiles_chrome_installations_chrome_installation_id");
                    ...
                    b.HasOne("EndpointPlatform.Domain.Devices.Device", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chrome_profiles_devices_device_id");
                });
            ...
            modelBuilder.Entity("EndpointPlatform.Domain.Devices.DeviceSoftwareEvidence", b =>
                {
                    b.HasOne("EndpointPlatform.Domain.Devices.DeviceSoftware", null)
                        .WithMany()
                        .HasForeignKey("DeviceSoftwareId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_device_software_evidence_device_software_device_software_id");
                });
            ...
            modelBuilder.Entity("EndpointPlatform.Domain.Software.SoftwareDeploymentTarget", b =>
                {
                    b.HasOne("EndpointPlatform.Domain.Software.SoftwareDeployment", null)
                        .WithMany()
                        .HasForeignKey("DeploymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_software_deployment_targets_software_deployments_deployment~");
                    ...
                    b.HasOne("EndpointPlatform.Domain.Devices.Device", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_software_deployment_targets_devices_device_id");
                });
